    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-3 w-1/4 min-w-[180px]">
                <div
                    className="w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-[10px] font-bold text-white shadow-md"
                    style={{ backgroundColor: getColorFromInitials(item.name) }}
                >
