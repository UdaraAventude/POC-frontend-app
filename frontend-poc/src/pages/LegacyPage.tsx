...
// Intentionally renders ALL records without virtualization to demonstrate
// the DOM explosion and jank that windowing solves. For comparison demo only.
        ...
        <>
            ...
            <main id="main-content" className="pt-16 px-4 sm:px-6 pb-6 flex-1 flex flex-col">
                <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col py-4 gap-3">
                    ...
                    >
                        <svg className="w-4 h-4 mt-0.5 text-red-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                    ...
                    {!isLoading && !error && (
                        <div className="flex items-center justify-between text-[10px] font-mono text-slate-600 px-1">
                            ...
                            <span>DOM nodes &gt; 150,000 · Compare with Optimized tab →</span>
                        </div>
                    )}
                </div>
            </main>
